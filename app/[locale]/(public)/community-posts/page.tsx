        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <Link 
              ...
              className={cn(buttonVariants({ variant: "default", size: "lg" }), "h-14 px-8 rounded-2xl shadow-xl shadow-primary/20")}
            >
          ...
          <main className="flex-1 space-y-8 flex flex-col">
            <div className="flex items-center justify-between">
              <p className="text-sm text-muted-foreground">
                {plT("showing")} <span className="font-bold text-foreground">{totalItems}</span> {t("posts")}
              </p>
              <Button 
                variant="outline" 
