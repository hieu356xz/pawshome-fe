        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
          <div className="flex-1 text-center md:text-left space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto md:mx-0">
              Welcome to PawsHome, where every wagging tail finds its happy ever after. Join our community of pet lovers dedicated to rescue, care, and adoption.
            </p>
            
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-4">
              <Link 
                href="/pets" 
                className={cn(buttonVariants({ variant: "default", size: "lg" }), "h-14 px-10 text-lg bg-primary hover:bg-primary/90 shadow-lg")}
              >
                Adopt a Pet
              </Link>
              <Link 
                href="/pet-posts" 
                className={cn(buttonVariants({ variant: "outline", size: "lg" }), "h-14 px-10 text-lg border-primary text-primary hover:bg-primary/5")}
              >
                Lost & Found
              </Link>
            </div>
            ...
            <div className="flex items-center justify-center md:justify-start space-x-12 pt-8">
              <div>
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wider">Pets Adopted</p>
              </div>
              <div className="border-l border-border pl-12">
                <p className="text-3xl font-serif font-bold text-primary">1200+</p>
          ...
          <div className="flex-1 w-full max-w-xl">
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
              {/* Using a placeholder-style design since I can't generate images here, but I'll use a warm background */}
            ...
            <div className="absolute -bottom-6 -right-6 md:right-12 bg-white p-6 rounded-xl shadow-xl border border-border hidden sm:block">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-bold text-sm">Community Support</p>
