          ...
          <div className="flex-1 text-center md:text-left space-y-8">
            ...
            <div className="flex items-center justify-center md:justify-start space-x-12 pt-8">
              <div>
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{t("statsAdopted")}</p>
              </div>
              <div className="border-l border-border pl-12">
                <p className="text-3xl font-serif font-bold text-primary">1200+</p>
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{t("statsMembers")}</p>
              </div>
            </div>
          </div>
            ...
            <div className="absolute -bottom-6 -right-6 md:right-12 bg-white p-6 rounded-xl shadow-xl border border-border hidden sm:block">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t("floatingBadgeDesc")}</p>
                </div>
              </div>
            </div>
          </div>
