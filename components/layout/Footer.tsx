    ...
    <footer className="w-full border-t bg-muted/30 pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif font-bold text-foreground mb-6">{t("quickLinks")}</h4>
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link href="/" className="hover:text-primary transition-colors">{t("home")}</Link></li>
              <li><Link href="/pets" className="hover:text-primary transition-colors">{t("findPet")}</Link></li>
              <li><Link href="/community-posts" className="hover:text-primary transition-colors">{t("communityPosts")}</Link></li>
              <li><Link href="/blog" className="hover:text-primary transition-colors">{t("petBlog")}</Link></li>
            </ul>
          </div>

          {/* Community */}
          <div>
            <h4 className="font-serif font-bold text-foreground mb-6">{t("community")}</h4>
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link href="/adoption" className="hover:text-primary transition-colors">{t("adoptionProcess")}</Link></li>
              <li><Link href="/volunteer" className="hover:text-primary transition-colors">{t("volunteer")}</Link></li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-serif font-bold text-foreground mb-6">{t("newsletter")}</h4>
